...
export interface ApiBlogCategoryBlogCategory
  ...
  info: {
    description: 'Categories a blog article can belong to. Shown as the tag on cards and in the blog sidebar.';
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'The whole site header in one place: logo, nav links, and CTA button.';
    displayName: 'Header';
    pluralName: 'headers';
    singularName: 'header';
  };
  ...
  attributes: {
    ...
    nav_links: Schema.Attribute.Component<'shared.nav-parent', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
